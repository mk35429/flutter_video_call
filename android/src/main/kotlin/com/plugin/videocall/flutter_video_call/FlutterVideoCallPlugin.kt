package com.plugin.videocall.flutter_video_call
...
import com.plugin.videocall.flutter_video_call.background_isolates.FlutterBgPerformingService
import com.google.firebase.messaging.FirebaseMessaging
import com.plugin.videocall.flutter_video_call.utils.*
...
/** FlutterVideoCallPlugin */
class FlutterVideoCallPlugin: FlutterPlugin, MethodCallHandler,
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    ...
    this.methodChannel =
      MethodChannel(
        ...
        "flutter_video_call.methodChannel"
      )
    ...
    this.eventChannel =
      EventChannel(
        flutterPluginBinding.binaryMessenger,
        "flutter_video_call.callEventChannel"
      )
  ...
  override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
    when (call.method) {
      ...
      "startBackgroundIsolate" -> {
        ...
        FlutterBgPerformingService.startBackgroundIsolate(
