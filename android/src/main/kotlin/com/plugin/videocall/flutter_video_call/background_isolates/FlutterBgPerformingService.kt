package com.plugin.videocall.flutter_video_call.background_isolates
...
class FlutterBgPerformingService : JobIntentService() {
    ...
    companion object {
        ...
        /**
         * Schedule the message to be handled by the [FlutterBgPerformingService].
         */
        fun enqueueMessageProcessing(context: Context, callEventIntent: Intent) {
            enqueueWork(
                context,
                FlutterBgPerformingService::class.java,
                2022,
                callEventIntent,
                true
            )
        ...
        /**
         * Starts the background isolate for the [FlutterBgPerformingService].
         *
         *
         * Preconditions:
         *
