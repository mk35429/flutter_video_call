...
/// {@endtemplate}
class FlutterVideoCall {
  static const MethodChannel _methodChannel =
      MethodChannel('flutter_video_call.methodChannel');
  static const EventChannel _eventChannel =
      EventChannel('flutter_video_call.callEventChannel');

  /// {@macro connectycube_flutter_call_kit}
  factory FlutterVideoCall() => _getInstance();

  const FlutterVideoCall._internal();

  static FlutterVideoCall get instance => _getInstance();
  static FlutterVideoCall? _instance;
  static String TAG = "ConnectycubeFlutterCallKit";

  static FlutterVideoCall _getInstance() {
    _instance ??= const FlutterVideoCall._internal();
    return _instance!;
  }
